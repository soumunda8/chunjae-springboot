...
<head>
    ...
    <link rel="stylesheet" href="${path }/resources/css/grids-responsive-min.css" />
    <link rel="stylesheet" href="${path }/resources/css/styles.css" />
    <style>
        .pricing-tables > table {width:100%;}
        .pricing-tables > table th {text-align:center;}
    </style>
</head>
<body>
        ...
        <div class="pricing-tables pure-g">
            <table class="pure-table pure-table-horizontal">
                ...
                <c:forEach var="user" items="${userList }" varStatus="status">
                    <tr>
                        <td>${status.count }</td>
                        <td><a href="${path }/user/get.do?name=${user.EName }">${user.userName }</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
